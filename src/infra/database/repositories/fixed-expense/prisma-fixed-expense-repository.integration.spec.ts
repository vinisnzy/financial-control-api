...
describe('Prisma fixed expense repository', () => {
	...
	it('should list all expenses', async () => {
		...
		await repository.create({ name: 'Supermarket', month: '2026-02', amount: 300.0, category: ExpenseCategory.FOOD, necessary: true, userId: USER_ID }, USER_ID)
		await repository.create({ name: 'Cinema', month: '2026-02', amount: 50.0, category: ExpenseCategory.LEISURE, necessary: false, userId: USER_ID }, USER_ID)
	...
	it('should find expense by id', async () => {
		...
		await repository.create({ name, month, amount, category, necessary, userId: USER_ID }, USER_ID)
	...
	it('should return null when current expenses does not have the corresponding name', async () => {
		...
		const response = await repository.findByNameAndMonth('Restaurant', '2026-02', USER_ID)
	...
	it('should return null when current expenses does not have the corresponding month', async () => {
		...
		const response = await repository.findByNameAndMonth('Supermarket', '2026-03', USER_ID)
	...
	it('should list expenses by month', async () => {
		...
		await repository.create({ name: 'Supermarket', month: '2026-02', amount: 300.0, category: ExpenseCategory.FOOD, necessary: true, userId: USER_ID }, USER_ID)
		await repository.create({ name: 'Cinema', month: '2026-02', amount: 50.0, category: ExpenseCategory.LEISURE, necessary: false, userId: USER_ID }, USER_ID)
		await repository.create({ name: 'Supermarket January', month: '2026-01', amount: 250.0, category: ExpenseCategory.FOOD, necessary: true, userId: USER_ID }, USER_ID)
	...
	it('should return an empty list when no necessary expenses for the month', async () => {
		...
		await repository.create({ name: 'Supermarket', month: '2026-02', amount: 300.0, category: ExpenseCategory.FOOD, necessary: false, userId: USER_ID }, USER_ID)
	...
	it('should update an existing expense', async () => {
		...
		const expense = new FixedExpense({ id, name, month, amount, category, necessary, userId: USER_ID })
