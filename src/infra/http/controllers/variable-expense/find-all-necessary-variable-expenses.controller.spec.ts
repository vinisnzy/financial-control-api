...
vi.mock('@/main/container.js', () => ({
	container: {
		findAllNecessaryVariableExpenses: {
...
describe('GET /variable-expenses/necessary', () => {
	...
	it('returns 200 and body is array with mapped variable expense data', async () => {
		const response = await app.inject({
			method: 'GET',
			url: '/variable-expenses/necessary',
		})
